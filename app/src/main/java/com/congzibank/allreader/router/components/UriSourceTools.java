...
public class UriSourceTools {
    ...
    public static final String FIELD_FROM = "com.congzibank.allreader.router.from";

    /**
     * Intent中Scheme跳转来源参数的Key
     */
    public static final String INTENT_KEY_URI_FROM = "com.congzibank.allreader.router.from";
